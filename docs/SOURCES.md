...
- Repositório oficial RT-DETR: https://github.com/lyuwenyu/RT-DETR
- MLflow Tracking: https://mlflow.org/docs/latest/ml/tracking/

As APIs de bibliotecas evoluem. Antes de uma bateria final de experimentos, registre as versões efetivamente instaladas (`pip freeze`) e mantenha-as fixas durante toda a comparação.
